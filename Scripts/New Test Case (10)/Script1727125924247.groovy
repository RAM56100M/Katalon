...
WebUI.click(findTestObject('Object Repository/Orange_HRM/Page_OrangeHRM/button_Admin_oxd-icon-button oxd-main-menu-button'))

WebUI.click(findTestObject('Object Repository/Orange_HRM/Page_OrangeHRM/p_2024-24-09 0241 AM'))
