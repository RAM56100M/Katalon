...
WebUI.setText(findTestObject('Object Repository/Orange_HRM/Page_OrangeHRM/input_Admin_oxd-input oxd-input--focus'), 'directory')

WebUI.click(findTestObject('Object Repository/Orange_HRM/Page_OrangeHRM/span_Directory'))

WebUI.click(findTestObject('Object Repository/Orange_HRM/Page_OrangeHRM/img_(99) Records Found_orangehrm-profile-pi_4091ed'))

WebUI.click(findTestObject('Object Repository/Orange_HRM/Page_OrangeHRM/button_Reset'))
