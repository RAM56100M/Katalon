...
WebUI.click(findTestObject('Object Repository/Orange_HRM/Page_OrangeHRM/span_Time'))

WebUI.setText(findTestObject('Object Repository/Orange_HRM/Page_OrangeHRM/input'), 'r')

WebUI.click(findTestObject('Object Repository/Orange_HRM/Page_OrangeHRM/button_View'))

WebUI.click(findTestObject('Object Repository/Orange_HRM/Page_OrangeHRM/button_Create Timesheet'))
