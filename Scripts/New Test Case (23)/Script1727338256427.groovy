...
WebUI.click(findTestObject('Object Repository/SauceLab/Page_Swag Labs/input_standard_userlocked_out_userproblem_u_0dff71'))
...
WebUI.setText(findTestObject('Object Repository/SauceLab/Page_Swag Labs/input_Checkout Your Information_first-name'), 'Ram')

WebUI.setText(findTestObject('Object Repository/SauceLab/Page_Swag Labs/input_Checkout Your Information_last-name'), 'Patil')

WebUI.setText(findTestObject('Object Repository/SauceLab/Page_Swag Labs/input_Checkout Your Information_postal-code'), '489657')
