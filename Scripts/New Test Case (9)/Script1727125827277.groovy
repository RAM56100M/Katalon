...
WebUI.click(findTestObject('Object Repository/Orange_HRM/Page_OrangeHRM/span_Buzz'))

WebUI.setText(findTestObject('Object Repository/Orange_HRM/Page_OrangeHRM/textarea_Upgrade_oxd-buzz-post-input'), 'Happy Birthday to all')

WebUI.click(findTestObject('Object Repository/Orange_HRM/Page_OrangeHRM/button_Post'))
