...
WebUI.click(findTestObject('Object Repository/Orange_HRM/Page_OrangeHRM/span_PIM'))

WebUI.setText(findTestObject('Object Repository/Orange_HRM/Page_OrangeHRM/input'), 't')

WebUI.click(findTestObject('Object Repository/Orange_HRM/Page_OrangeHRM/input_Employee Id_oxd-input oxd-input--focus'))

WebUI.click(findTestObject('Object Repository/Orange_HRM/Page_OrangeHRM/i_-- Select --_oxd-icon bi-caret-up-fill ox_627fec'))

WebUI.click(findTestObject('Object Repository/Orange_HRM/Page_OrangeHRM/i_Current Employees Only_oxd-icon bi-caret-_0b22a7'))

WebUI.click(findTestObject('Object Repository/Orange_HRM/Page_OrangeHRM/i_Current Employees Only_oxd-icon bi-caret-_0b22a7'))

WebUI.click(findTestObject('Object Repository/Orange_HRM/Page_OrangeHRM/input_1'))
